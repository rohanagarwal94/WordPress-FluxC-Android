...
public class AccountRestClient extends BaseWPComRestClient {
    ...
    public void getMySettings() {
        ...
        final WPComGsonRequest<AccountSettingsResponse> request = new WPComGsonRequest<>(Method.GET,
                url, null, AccountSettingsResponse.class,
                new Listener<AccountSettingsResponse>() {
                    @Override
                    public void onResponse(AccountSettingsResponse response) {
                        AccountSettingsModel settings = responseToAccountSettingsModel(response);
    ...
    private AccountSettingsModel responseToAccountSettingsModel(AccountSettingsResponse from) {
        AccountSettingsModel accountSettings = new AccountSettingsModel();
        accountSettings.setPrimarySiteId(from.primary_site_ID);
